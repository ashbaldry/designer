var h=class{name;navbar_item_style="none";bs4_item_style="none";enable_on_load=!0;page_html;constructor(){}updateComponentDropdown(){$(".navbar-tab-item").css("display",this.navbar_item_style),$(".bs4-item").css("display",this.bs4_item_style),this.navbar_item_style==="none"?$("#settings-component a[name='header']").trigger("click"):$("#settings-component a[name='tab_panel']").trigger("click")}getPageHTML(t,e=""){return t.replaceAll("$page_id$",this.getTabID()).replaceAll("$title$",e)}updatePage(){let t=$("#canvas-title").html();$(".page-canvas").html(this.getPageHTML(this.page_html,t))}enableSortablePage(t){Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(e,a,n){return!n.classList.contains("col-sm")}}})}getTabID(){return Math.round(Math.random()*8999+1e3)}};var y=class extends h{name="basicPage";page_html=`
    ...
    `};var T=class extends h{name="fluidPage";page_html=`
        <div id="canvas-page" class="designer-page-template container-fluid" 
             data-shinyfunction="fluidPage"
             data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
    `};var C=class extends h{name="bootstrapPage";page_html=`
        <div id="canvas-page" class="designer-page-template container-fluid" 
             data-shinyfunction="bootstrapPage"
             data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
    `};var q=class extends h{name="navbarPage";navbar_item_style="";enable_on_load=!1;page_html=`
    ...
    `};var P=class extends h{name="dashboardPage";navbar_item_style="";bs4_item_style="";enable_on_load=!1;page_html=`
...
Choice 2`),this.updateTextInput("width","")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("checkbox"):e;var a=$("#sidebar-type").val();let n=this.types.find(_=>_.value===a);if(!n)return;let i=n.r_func,r=n.role,l=this.validateCssUnit($("#sidebar-width").val()),d=l?`width: ${l};`:"",p=l?`, width = &quot;${l}&quot;`:"";var u=document.getElementById("sidebar-inline").checked;let v=`shiny-input-${a}group${u?"-inline":""}`,f=$("#sidebar-choices").val(),b=`, choices = c(&quot;${f.replace(/\n/g,"&quot;, &quot;")}&quot;)`,x=f.split(`
`).map(_=>this.createCheckbox(_,e=e,a=a,u=u)).join("");return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,css_class:v,r_func:i,role:r,choices:x,choices_str:b,style_str:d,width_str:p})}createCheckbox(t,e="",a="checkbox",n=!1){var i=n?a+"-inline":a;return`<label class="${i}"><input type="${a}"><span>${t}</span></label>`}};var E=class extends o{name="Slider Input";parameters=["type","id","label","range","width"];types=[{value:"number",label:"Numeric"},{value:"date",label:"Date"},{value:"datetime",label:"Timestamp"}];notes=["To position several inputs horizontally, they must be put within an input panel."];html=`
        <div class="designer-element form-group shiny-input-container" $style_str$
