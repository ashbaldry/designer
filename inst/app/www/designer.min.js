var b=class{name;navbar_item_style="none";bs4_item_style="none";enable_on_load=!0;page_html;updateComponentDropdown(){$(".navbar-tab-item").css("display",this.navbar_item_style),$(".bs4-item").css("display",this.bs4_item_style);let t=this.navbar_item_style==="none"?"header":"tab";$(`#sidebar-${t}-body`).hasClass("show")||$(`#sidebar-${t}-header button`).trigger("click")}getPageHTML(t,e=""){return t.replaceAll("$page_id$",this.getTabID()).replaceAll("$title$",e)}updatePage(){let t=$("#canvas-title").html();$(".page-canvas").html(this.getPageHTML(this.page_html,t))}enableSortablePage(t,e="id"){e==="id"?Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(a,n,o){return!o.classList.contains("col-sm")}}}):document.getElementsByClassName(t).forEach(a=>{Sortable.create(a,{group:{name:"shared",put:function(n,o,l){return!l.classList.contains("col-sm")}}})})}getTabID(){return Math.round(Math.random()*8999+1e3)}};var C=class extends b{name="basicPage";enable_on_load=!1;page_html='<div id="canvas-page" class="container-fluid dimmed-canvas-page"></div>'};var P=class extends b{name="fillPage";page_html=`
  ...
  `};var D=class extends b{name="navbarPage";navbar_item_style="";enable_on_load=!1;page_html=`
    ...
    `};var S=class extends b{name="dashboardPage";navbar_item_style="";bs4_item_style="";enable_on_load=!1;page_html=`
...
`).map(e=>'<li data-shinyfunction="tags$li">'+e+"</li>").join("")}};var B=class extends c{updatable=!1;html='<div class="designer-element shiny-input-panel shiny-flow-layout" data-shinyfunction="inputPanel"></div>';constructor(){super(),this.updateComponent(!0)}sortable_settings={group:{name:"shared",put:function(t,e,a){return a.classList.contains("form-group")||a.classList.contains("btn")}}}};var E=class extends c{constructor(t){super(),this.type=t,this.updateComponent(!0)}types=[{value:"text_input",label:"Text",r_func:"textInput"},{value:"textarea",label:"Textarea",r_func:"textAreaInput"},{value:"numeric",label:"Numeric",r_func:"numericInput"},{value:"password",label:"Password",r_func:"passwordInput"}];html=`
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-file-label").val(),e=$("#sidebar-file-id").val();e=e===""?this.createID("input"):e;let a=this.validateCssUnit($("#sidebar-file-width").val()),n=a?`style="width: ${a};"`:"",o=a?`, width = &quot;${a}&quot;`:"";return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,style_str:n,width_str:o})}};var N=class extends c{html=`
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-dropdown-label").val(),e=$("#sidebar-dropdown-id").val();e=e===""?this.createID("input"):e;let a=this.validateCssUnit($("#sidebar-dropdown-width").val()),n=a?`style="width: ${a};"`:"",o=a?`, width = &quot;${a}&quot;`:"";return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,style_str:n,width_str:o})}updateComponent(t=!1){if(super.updateComponent(t),typeof window>"u")return null;$(".component-container").find("select").selectize({labelField:"label",valueField:"value",searchField:["label"],placeholder:"select input"})}};var U=class extends c{html=`
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-date-label").val(),e=$("#sidebar-date-id").val();e=e===""?this.createID("input"):e;let a=this.validateCssUnit($("#sidebar-date-width").val()),n=a?`style="width: ${a};"`:"",o=a?`, width = &quot;${a}&quot;`:"",l=document.getElementById("sidebar-date-range").checked,i=l?"dateRangeInput":"dateInput",r=l?"shiny-date-range-input":"shiny-date-input",d=l?this.date_range_input_html:this.date_input_html;return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,r_func:i,date_class:r,input_tag:d,style_str:n,width_str:o})}updateComponent(t=!1){if(super.updateComponent(t),typeof window>"u")return null;$(".component-container").find("input").bsDatepicker()}};var O=class extends c{html=`
      <div class="designer-element form-group shiny-input-container" $style_str$
  ...
  `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-checkbox-label").val(),e=$("#sidebar-checkbox-id").val();e=e===""?this.createID("checkbox"):e;let a=this.validateCssUnit($("#sidebar-checkbox-width").val()),n=a?`style="width: ${a};"`:"",o=a?`, width = &quot;${a}&quot;`:"";return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,style_str:n,width_str:o})}};var R=class extends c{types=[{value:"radio",label:"Radio",r_func:"radioButtons",role:"radiogroup"},{value:"checkbox",label:"Checkbox",r_func:"checkboxGroupInput",role:"group"}];html=`
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-radio-label").val(),e=$("#sidebar-radio-id").val();e=e===""?this.createID("checkbox"):e;let a=$("#sidebar-radio-type").val(),n=this.types.find(x=>x.value===a);if(!n)return;let o=n.r_func,l=n.role,i=this.validateCssUnit($("#sidebar-radio-width").val()),r=i?`style="width: ${i};"`:"",d=i?`, width = &quot;${i}&quot;`:"",u=document.getElementById("sidebar-radio-inline").checked,p=u?"-inline":"",f=u?", inline = TRUE":"",v=`shiny-input-${a}group${p}`,h=$("#sidebar-radio-choices").val(),_=`, choices = c(&quot;${h.replace(/\n/g,"&quot;, &quot;")}&quot;)`,K=h.split(`
`).map(x=>this.createCheckbox(x,a,u)).join("");return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,css_class:v,r_func:o,role:l,choices:K,choices_str:_,inline_str:f,style_str:r,width_str:d})}createCheckbox(t,e="checkbox",a=!1){return`<label class="${a?e+"-inline":e}"><input type="${e}"><span>${t}</span></label>`}};var V=class extends c{html=`
        <div class="designer-element form-group shiny-input-container" $style_str$
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-info_box-value").val(),e=$("#sidebar-info_box-label").val(),a=$("#sidebar-info_box-width_num").val(),n=a>0?`col-sm col-sm-${a}`:"",o=a>0?a:"NULL",l=$("#sidebar-info_box-icon").val(),i=l===""?"":`, icon = icon(&quot;${l}&quot;)`,r=l===""?"":$("#sidebar-info_box-icon option").html().includes("fab")?"fab":"fa",d=l===""?"":`<i aria-hidden="true" class="${r} fa-${l} fa-fw" role="presentation"></i>`,u=$("#sidebar-info_box-background").val(),p=`bg-${u}`,f=document.getElementById("sidebar-info_box-fill").checked,v=f?", fill = TRUE":"";return this.replaceHTMLPlaceholders(this.html,{value:t,label:e,width_class:n,width_r:o,icon_html:d,icon_r:i,colour:u,colour_class:f?p:"",colour_class2:f?"":p,fill_r:v})}};var G=class extends c{html='<blockquote class="designer-element quote-$colour$" data-shinyfunction="bs4Dash::blockQuote" data-shinyattributes="color = &quot;$colour$&quot;">$value$</blockquote>';constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-quote-colour").val(),e=$("#sidebar-quote-textarea").val();return this.replaceHTMLPlaceholders(this.html,{colour:t,value:e})}};var Q=class extends c{html=`
        <div class="designer-element $width_class$">
