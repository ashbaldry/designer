...
Choice 2`),this.updateTextInput("width","")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("checkbox"):e;var a=$("#sidebar-type").val();let n=this.types.find(f=>f.value===a);if(!n)return;let l=n.r_func,r=n.role,o=this.validateCssUnit($("#sidebar-width").val()),d=o?`width: ${o};`:"",h=o?`, width = &quot;${o}&quot;`:"";var u=document.getElementById("sidebar-inline").checked;let v=`shiny-input-${a}group${u?"-inline":""}`,g=$("#sidebar-choices").val(),m=`, choices = c(&quot;${g.replace(/\n/g,"&quot;, &quot;")}&quot;)`,w=g.split(`
`).map(f=>this.createCheckbox(f,e=e,a=a,u=u)).join("");return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,css_class:v,r_func:l,role:r,choices:w,choices_str:m,style_str:d,width_str:h})}createCheckbox(t,e="",a="checkbox",n=!1){var l=n?a+"-inline":a;return`<label class="${l}"><input type="${a}"><span>${t}</span></label>`}};var N=class extends i{name="Slider Input";parameters=["type","id","label","range","width"];types=[{value:"number",label:"Numeric"},{value:"date",label:"Date"},{value:"datetime",label:"Timestamp"}];notes=["To position several inputs horizontally, they must be put within an input panel."];html=`
        <div class="designer-element form-group shiny-input-container" $style_str$
    ...
    `;constructor(){super(),this.showRelevantOptions(),this.updateType(),this.updateTextInput("id",""),this.updateTextInput("label","Label"),this.updateTextInput("height","400px"),this.updateTextInput("width","100%"),this.updateLabel("id","Output ID")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("output"):e;let a=$("#sidebar-type").val(),n=this.types.find(m=>m.value===a);if(!n)return;let l=n.r_func,r=a==="verbatim"?"pre":"div",o=n.css_class,d="";if(["plot","image","table"].includes(a)){let m=this.createID("output");Shiny.setInputValue("sidebar-outputid",m),d=`id="sidebar-${m}"`}let u=document.getElementById("sidebar-inline").checked&&!["verbatim","table"].includes(a)?", inline = TRUE":"";u!==""&&(r="span");let b="",v="";if(["plot","image"].includes(a)){let m=this.validateCssUnit($("#sidebar-width").val(),"100%"),w=`width: ${m};`,f=m==="100%"?"":`, width = &quot;${m}&quot;`,j=this.validateCssUnit($("#sidebar-height").val(),"400px");w=w+` height: ${j};`,f=f+(j==="400px"?"":`, height = &quot;${j}&quot;`)}let g="";return n.placeholder&&(a==="html"?g=`<span>${n.placeholder}</span>`:g=`<span>${n.placeholder} ${$("#sidebar-textarea").val()}</span>`),this.replaceHTMLPlaceholders(this.html,{html_tag:r,id:e,label:t,id_str:d,r_func:l,css_class:o,style_str:v,dim_str:b,inline_str:u,output_tag:g})}updateComponent(t=!1){super.updateComponent(t),Shiny.bindAll()}};var A=class extends i{_item=1;name="Tab";constructor(){super(),$("#component_settings").css("display","none"),$("#tab_settings").css("display","unset")}updateComponent(){}getPageType(){return $("#settings-page_type input:radio:checked").val()}addPage(){let t=this.getPageType(),e=$("#sidebar-tab_name").val();if(this.checkDuplicateNames(e,t))return;let a=$("#sidebar-tab_value").val();a===""&&(a=this.createID("tab")),!this.checkDuplicateIDs(a,t)&&($("#sidebar-tab_alert div").alert("close"),t==="dashboardPage"?this.addMenuItem(e,a):this.addTab(e,a))}addTab(t,e){let a=$("ul.navbar-nav"),n=a.data("tabsetid"),l=$(".tab-content"),r=l.html()===""?"active":"";a.append(`
        ...
        `),this.enableSortablePage(`shiny-tab-${e}`)}enableSortablePage(t){Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(e,a,n){return!n.classList.contains("col-sm")}}})}checkDuplicateNames(t,e){return $(this.getNameIdentifier(t,e)).length>0?($("#sidebar-tab_alert").html(`
            ...
            `),!1)}};var V=class extends i{name="Box";parameters=["label","colour","background","width_num"];notes=["If the width > 0, then the box is included in a column and can only be included in <b>rows</b>","Rows are split into 12 column units, if the sum of boxs' width exceeds 12, they get wrapped onto a new line"];html=`
