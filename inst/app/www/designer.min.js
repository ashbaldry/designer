var b=class{name;navbar_item_style="none";bs4_item_style="none";enable_on_load=!0;page_html;updateComponentDropdown(){$(".navbar-tab-item").css("display",this.navbar_item_style),$(".bs4-item").css("display",this.bs4_item_style);let t=this.navbar_item_style==="none"?"header":"tab";$(`#sidebar-${t}-body`).hasClass("show")||$(`#sidebar-${t}-header button`).trigger("click")}getPageHTML(t,e=""){return t.replaceAll("$page_id$",this.getTabID()).replaceAll("$title$",e)}updatePage(){let t=$("#canvas-title").html();$(".page-canvas").html(this.getPageHTML(this.page_html,t))}enableSortablePage(t,e="id"){e==="id"?Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(a,n,i){return!i.classList.contains("col-sm")}}}):document.getElementsByClassName(t).forEach(a=>{Sortable.create(a,{group:{name:"shared",put:function(n,i,l){return!l.classList.contains("col-sm")}}})})}getTabID(){return Math.round(Math.random()*8999+1e3)}};var q=class extends b{name="basicPage";enable_on_load=!1;page_html='<div id="canvas-page" class="container-fluid dimmed-canvas-page"></div>'};var I=class extends b{name="fillPage";page_html=`
    ...
    `};var T=class extends b{name="fluidPage";page_html=`
        <div id="canvas-page" class="designer-page-template container-fluid" 
             ...
             data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
    `};var D=class extends b{name="bootstrapPage";page_html=`
    <div id="canvas-page" class="designer-page-template container-fluid" data-shinyfunction="bootstrapPage"
      data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
  `};var S=class extends b{name="navbarPage";navbar_item_style="";enable_on_load=!1;page_html=`
    ...
    `};var L=class extends b{name="dashboardPage";navbar_item_style="";bs4_item_style="";enable_on_load=!1;page_html=`
...
`).map(e=>'<li data-shinyfunction="tags$li">'+e+"</li>").join("")}};var x=class extends c{updatable=!1;html='<div class="designer-element shiny-input-panel shiny-flow-layout" data-shinyfunction="inputPanel"></div>';constructor(){super(),this.updateComponent(!0)}sortable_settings={group:{name:"shared",put:function(t,e,a){return a.classList.contains("form-group")||a.classList.contains("btn")}}}};var H=class extends c{constructor(t){super(),this.type=t,this.updateComponent(!0)}types=[{value:"text_input",label:"Text",r_func:"textInput"},{value:"textarea",label:"Textarea",r_func:"textAreaInput"},{value:"numeric",label:"Numeric",r_func:"numericInput"},{value:"password",label:"Password",r_func:"passwordInput"}];html=`
  ...
  `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-checkbox-label").val(),e=$("#sidebar-checkbox-id").val();e=e===""?this.createID("checkbox"):e;let a=this.validateCssUnit($("#sidebar-checkbox-width").val()),n=a?`style="width: ${a};"`:"",i=a?`, width = &quot;${a}&quot;`:"";return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,style_str:n,width_str:i})}};var R=class extends c{types=[{value:"radio",label:"Radio",r_func:"radioButtons",role:"radiogroup"},{value:"checkbox",label:"Checkbox",r_func:"checkboxGroupInput",role:"group"}];html=`
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-radio-label").val(),e=$("#sidebar-radio-id").val();e=e===""?this.createID("checkbox"):e;let a=$("#sidebar-radio-type").val(),n=this.types.find(C=>C.value===a);if(!n)return;let i=n.r_func,l=n.role,o=this.validateCssUnit($("#sidebar-radio-width").val()),r=o?`style="width: ${o};"`:"",d=o?`, width = &quot;${o}&quot;`:"",u=document.getElementById("sidebar-radio-inline").checked,p=u?"-inline":"",g=u?", inline = TRUE":"",v=`shiny-input-${a}group${p}`,h=$("#sidebar-radio-choices").val(),_=`, choices = c(&quot;${h.replace(/\n/g,"&quot;, &quot;")}&quot;)`,K=h.split(`
`).map(C=>this.createCheckbox(C,a,u)).join("");return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,css_class:v,r_func:i,role:l,choices:K,choices_str:_,inline_str:g,style_str:r,width_str:d})}createCheckbox(t,e="checkbox",a=!1){return`<label class="${a?e+"-inline":e}"><input type="${e}"><span>${t}</span></label>`}};var V=class extends c{html=`
        <div class="designer-element form-group shiny-input-container" $style_str$
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-info_box-value").val(),e=$("#sidebar-info_box-label").val(),a=$("#sidebar-info_box-width_num").val(),n=a>0?`col-sm col-sm-${a}`:"",i=a>0?a:"NULL",l=$("#sidebar-info_box-icon").val(),o=l===""?"":`, icon = icon(&quot;${l}&quot;)`,r=l===""?"":$("#sidebar-info_box-icon option").html().includes("fab")?"fab":"fa",d=l===""?"":`<i aria-hidden="true" class="${r} fa-${l} fa-fw" role="presentation"></i>`,u=$("#sidebar-info_box-background").val(),p=`bg-${u}`,g=document.getElementById("sidebar-info_box-fill").checked,v=g?", fill = TRUE":"";return this.replaceHTMLPlaceholders(this.html,{value:t,label:e,width_class:n,width_r:i,icon_html:d,icon_r:o,colour:u,colour_class:g?p:"",colour_class2:g?"":p,fill_r:v})}};var G=class extends c{html='<blockquote class="designer-element quote-$colour$" data-shinyfunction="bs4Dash::blockQuote" data-shinyattributes="color = &quot;$colour$&quot;">$value$</blockquote>';constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-quote-colour").val(),e=$("#sidebar-quote-textarea").val();return this.replaceHTMLPlaceholders(this.html,{colour:t,value:e})}};var Q=class extends c{html=`
        <div class="designer-element $width_class$">
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-callout-label").val(),e=$("#sidebar-callout-colour").val(),a=$("#sidebar-callout-textarea").val(),n=$("#sidebar-callout-width_num").val(),i=n>0?`col-sm col-sm-${n}`:"",l=n>0?n:"NULL";return this.replaceHTMLPlaceholders(this.html,{title:t,status:e,value:a,width_r:l,width_class:i})}};function tt(s){return s==="header"?new P:s==="row"?new y:s==="column"?new w:s==="text"?new B:s==="input_panel"?new x:["text_input","numeric","textarea","password"].includes(s)?new H(s):s==="dropdown"?new N:s==="file"?new E:s==="date"?new U:s==="checkbox"?new O:s==="radio"?new R:s==="slider"?new V:s==="button"?new A:s==="output"?new F:s==="tab_panel"?new j:s==="tabset"?new z:s==="box"?new Y:s==="user_box"?new X:s==="value_box"?new W:s==="info_box"?new J:s==="quote"?new G:s==="callout"?new Q:new P}function bt(){tt("header"),$(".component-settings").on("change keyup",()=>f.updateComponent()),$(".component-comments").on("change blur",()=>f.updateComponent()),$(".component-container").on("mouseover",()=>{$(":focus").trigger("blur")}),$(".add-tab-button").on("click",()=>f.addPage()),$(".delete-tab-button").on("click",()=>f.deletePage()),$(".accordion .card-header .btn").on("click",s=>{$(s.target).closest(".card").find("form").trigger("reset");let t=$(s.target).data("shinyelement");tt(t),document.getElementById("sidebar-container").style.display=t==="tab_panel"?"none":null})}function et(s,t=!1){let e=$t(s),a={tagName:s.tagName.toLowerCase(),r_function:s.dataset.shinyfunction,r_arguments:s.dataset.shinyattributes,r_comments:s.dataset.shinycomments,text:$(s).ignore().text().replace(/\s*\n\s*/g,""),htmlclass:s.className,children:e};return t?a:JSON.stringify(a)}$.fn.ignore=function(s){return this.clone().find(s||">*").remove().end()};function $t(s){let t=[];for(let e=0;e<s.children.length;e++)if(s.children[e].dataset.shinyfunction)t.push(et(s.children[e],!0));else if(s.children[e].children.length){let a=$t(s.children[e]);a.length>0&&(t=t.concat(a))}return t}var at=new Shiny.InputBinding;$.extend(at,{find:function(s){return $(s).find(".page-canvas")},getValue:function(s){return et(document.getElementById("canvas-page"))},subscribe:function(s,t){new MutationObserver(function(){t()}).observe(s,{subtree:!0,childList:!0,attributes:!0})},unsubscribe:function(s){$(s).off(".page-canvas")}});var nt=new Shiny.InputBinding;$.extend(nt,{find:function(s){return $(s).find(".page-canvas-shell")},getValue:function(s){return $(s).find(".page-canvas").html()},setValue:function(s,t){$(s).find(".page-canvas").html(t)},subscribe:function(s,t){new MutationObserver(function(){t()}).observe(s,{subtree:!0,childList:!0,attributes:!0})},unsubscribe:function(s){$(s).off(".page-canvas-shell")},receiveMessage(s,t){this.setValue(s,t),$(".canvas-modal").css("display","none"),m.enableSortablePage("canvas-page"),m.updateComponentDropdown(),new c().enableSortable();let e=new w().sortable_settings,a=new y().sortable_settings,n=new x().sortableSettings;St.map(i=>st(i,e)),st("designer-element row",a),st("designer-element shiny-input-panel",n)}});var St=["tab-pane","designer-element col-sm","designer-element card-body"];function st(s,t){document.getElementsByClassName(s).forEach(e=>{Sortable.create(e,t)})}$(function(){ht(),bt(),lt(),$(".help-icon").tooltip({boundary:"window",placement:"right"}),bsCustomFileInput.init(),Sortable.create(document.getElementById("sidebar-bin"),{group:{name:"shared",pull:!1},handle:".designer-element",draggable:".designer-element",onAdd:function(s){this.el.removeChild(s.item)}})});Shiny.inputBindings.register(at);Shiny.inputBindings.register(nt);
