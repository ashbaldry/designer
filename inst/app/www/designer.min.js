var p=class{navbar_item_style="none";bs4_item_style="none";enable_on_load=!0;page_html;constructor(){}updateComponentDropdown(){$(".navbar-tab-item").css("display",this.navbar_item_style),$(".bs4-item").css("display",this.bs4_item_style),this.navbar_item_style==="none"?$("#settings-component a[name='header']").trigger("click"):$("#settings-component a[name='tab_panel']").trigger("click")}getPageHTML(t,e=""){return t.replaceAll("$page_id$",this.getTabID()).replaceAll("$title$",e)}updatePage(){let t=$("#canvas-title").html();$(".page-canvas").html(this.getPageHTML(this.page_html,t))}enableSortablePage(t){Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(e,a,n){return!n.classList.contains("col-sm")}}})}getTabID(){return Math.round(Math.random()*8999+1e3)}};var _=class extends p{page_html=`
    ...
    `};var I=class extends p{page_html=`
        <div id="canvas-page" class="designer-page-template container-fluid" 
             data-shinyfunction="fluidPage"
             data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
    `};var T=class extends p{page_html=`
        <div id="canvas-page" class="designer-page-template container-fluid" 
             data-shinyfunction="bootstrapPage"
             data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
    `};var C=class extends p{navbar_item_style="";enable_on_load=!1;page_html=`
    ...
    `};var q=class extends p{navbar_item_style="";bs4_item_style="";enable_on_load=!1;page_html=`
    ...
    `};function k(){var s=$("#settings-page_type input:radio:checked").val(),t;return s==="basicPage"?t=new _:s==="fillPage"?t=new x:s==="fluidPage"?t=new I:s==="bootstrapPage"?t=new T:s==="navbarPage"?t=new C:s==="dashboardPage"?t=new q:t=new _,t.updatePage(),t.enable_on_load&&t.enableSortablePage("canvas-page"),t.updateComponentDropdown(),t}function W(){$("#canvas-page").html()===""||$("#canvas-page.wrapper .tab-content").html()===""?($("#canvas-page").html("<div></div>"),k()):$("#warning_modal").modal()}function K(s){let t=$(s.target).val();if($("#canvas-title").html(t),$(".navbar-brand").html(t),$(".brand-link").html(t),$("#canvas-page").data("shinyattributes")){var e=$("#canvas-page").data("shinyattributes").replace(/"[^"]+"/,`"${t}"`);$("#canvas-page").attr("data-shinyattributes",e)}if($("#canvas-page>.main-header").data("shinyattributes")){var a=$("#canvas-page>.main-header").data("shinyattributes").replace(/"[^"]+"/,`"${t}"`);$("#canvas-page>.main-header").attr("data-shinyattributes",a)}}function Q(){k(),$("#settings-page_type").on("change",W),$("#confirm_reset").on("click",k),$("#app_name").on("change keyup",K)}function X(){$(".copy-ui-button").on("click",nt),$("#remove_label").on("change",et),$("#remove_colour").on("change",at),$("#remove_border").on("change",st),$(document).on("click",".clickable-dropdown",s=>{s.stopPropagation()}),$("#preview").on("click",()=>{$(".page-canvas-shell").addClass("preview")}),$("#canvas-close_preview").on("click",()=>{$(".page-canvas-shell").removeClass("preview")}),Shiny.addCustomMessageHandler("toggleBS4DashDeps",it)}function et(){this.checked?$(".designer-page-template").removeClass("hidden-after-label"):$(".designer-page-template").addClass("hidden-after-label")}function at(){this.checked?$(".designer-page-template").removeClass("hidden-colour"):$(".designer-page-template").addClass("hidden-colour")}function st(){this.checked?$(".designer-page-template").removeClass("hidden-borders"):$(".designer-page-template").addClass("hidden-borders")}function nt(){var s=document.getElementById("settings-code-code").textContent;navigator.clipboard.writeText(s)}function it(s){let t=document.styleSheets;for(var e=0;e<t.length;e++){var a=t.item(e);(a.href.includes("AdminLTE")||a.href.includes("bs4Dash"))&&(a.disabled=s==="hide")}}var i=class{updatable=!0;display_comments=!0;display_container=!0;name;parameters;tags;types;notes;sortable_settings;html;constructor(){$("#component_settings").css("display",""),$("#tab_settings").css("display","none"),this.updateLabels([{id:"type",text:"Type"},{id:"id",text:"Input ID"}])}showRelevantOptions(){$(".component-settings").css("display","");for(let t=0;t<this.parameters.length;t++)$(".component-settings[data-component= '"+this.parameters[t]+"']").css("display","unset");this.updateTitle(),this.updateNotes(),$(".component-container").css("display",this.display_container?"":"none"),$(".component-comments").css("display",this.display_comments?"":"none")}updateTitle(){let t=this.name?`${this.name} Settings`:null;$("#sidebar-title").html(t)}updateNotes(){if($("#sidebar-notes").html(null),this.notes){$("#sidebar-notes").html("<h3>Notes</h3><ul></ul>");for(let t=0;t<this.notes.length;t++)$("#sidebar-notes ul").append("<li>"+this.notes[t]+"</li>")}}createComponent(){return this.html}replaceHTMLPlaceholders(t,e){for(let a in e)t=t.replaceAll("$"+a+"$",e[a]);return t}updateComponent(t=!1){$(".component-container").html(null);let e=this.createComponent();$(".component-container").html(e),this.addComments(),t&&this.enableSortable()}enableSortable(){Sortable.create(document.getElementById("sidebar-container"),{group:{name:"shared",pull:"clone",put:!1},onClone:function(t){c.sortable_settings&&(c.name==="Box"?Sortable.create($(t.item).find(".card-body")[0],c.sortable_settings):Sortable.create(t.item,c.sortable_settings))},onEnd:function(t){$('.page-canvas [data-toggle="tooltip"]').tooltip(),(c.updatable||$("#sidebar-comments").val()!=="")&&($("#sidebar-comments").val(""),c.updateComponent())}})}addComments(){let t=$("#sidebar-comments").val();t&&($(".component-container>.designer-element").attr("data-shinycomments",t),$(".component-container>.designer-element").attr("title",t),$(".component-container>.designer-element").attr("data-toggle","tooltip"))}updateTag(){if(this.tags){var t=$("#sidebar-tag").selectize()[0].selectize;t.clearOptions(!0),t.addOption(this.tags),t.refreshOptions(!1),t.addItem(this.tags[0].value)}}updateType(){if(this.types){var t=$("#sidebar-type").selectize()[0].selectize;t.clearOptions(!0),t.addOption(this.types),t.refreshOptions(!1),t.addItem(this.types[0].value)}}updateTextInputs(t){for(var e=0;e<t.length;e++)this.updateTextInput(t[e].id,t[e].text)}updateTextInput(t,e=""){$(`#sidebar-${t}`).val(e)}updateLabels(t){for(var e=0;e<t.length;e++)this.updateLabel(t[e].id,t[e].text)}updateLabel(t,e=""){$(`label[for='sidebar-${t}']`).html(e)}createID(t=""){return t=t&&t+"_",t+Math.random().toString(36).substring(2,12)}validateCssUnit(t,e){return this._regex.test(t)?t:/^\d+$/.test(t)?t+"px":e}_regex=/^(auto|inherit|fit-content|calc\(.*\)|((\.\d+)|(\d+(\.\d+)?))(%|in|cm|mm|ch|em|ex|rem|pt|pc|px|vh|vw|vmin|vmax))$/};var y=class extends i{name="Header";parameters=["tag","text"];tags=[{value:"h1",label:"h1",text:"h1"},{value:"h2",label:"h2",text:"h2"},{value:"h3",label:"h3",text:"h3"},{value:"h4",label:"h4",text:"h4"},{value:"h5",label:"h5",text:"h5"},{value:"h6",label:"h6",text:"h6"}];html='<$tag$ class="designer-element" data-shinyfunction="$tag$">$value$</$tag$>';constructor(){super(),this.showRelevantOptions(),this.updateTag(),this.updateTextInput("text","Header")}createComponent(){let t=$("#sidebar-tag").val(),e=$("#sidebar-text").val();return this.replaceHTMLPlaceholders(this.html,{tag:t,value:e})}};var P=class extends i{name="Row";parameters=[];updatable=!1;html='<div class="designer-element row row-designer" data-shinyfunction="fluidRow"></div>';notes=["The only component that can be a direct child of a row are columns.","By default, a row will have no height and is determined by the contents inside. To easily drop elements into the rows, they have a minimum height of 50px in this app."];sortable_settings={group:{name:"shared",put:function(t,e,a){return a.classList.contains("col-sm")}}};constructor(){super(),this.showRelevantOptions()}};var L=class extends i{name="Column";parameters=["width_num","offset"];updatable=!1;html=`
    ...
    `;notes=["Columns can only be included in <b>rows</b>.","Rows are split into 12 column units, if the sum of columns' width exceeds 12, they get wrapped onto a new line."];sortable_settings={group:{name:"shared",put:function(t,e,a){return!a.classList.contains("col-sm")}}};constructor(){super(),this.showRelevantOptions()}createComponent(){let t=$("#sidebar-width_num").val(),e=$("#sidebar-offset").val(),a=e>0?` offset-md-${e}`:"",n=e>0?`, offset = ${e}`:"";return this.replaceHTMLPlaceholders(this.html,{width:t,offset_class:a,offset_r:n})}};var D=class extends i{name="Text";parameters=["tag","textarea"];tags=[{value:"p",label:"Paragraph <p>",text:"Paragraph <p>"},{value:"ol",label:"Ordered List <ol>",text:"Ordered List <ol>"},{value:"ul",label:"Unordered List <ul>",text:"Unordered List <ul>"}];html='<$tag$ class="designer-element" data-shinyfunction="tags$$tag$">$value$</$tag$>';constructor(){super(),this.showRelevantOptions(),this.updateTag(),this.updateTextInput("textarea","")}createComponent(){let t=$("#sidebar-tag").val(),e=$("#sidebar-textarea").val(),a=t==="p"?e.replace(/\n/g," "):this.createListItems(e);return this.replaceHTMLPlaceholders(this.html,{tag:t,value:a})}createListItems(t){return t.split(`
`).map(e=>'<li data-shinyfunction="tags$li">'+e+"</li>").join("")}};var S=class extends i{name="Input Panel";parameters=[];updatable=!1;html='<div class="designer-element shiny-input-panel shiny-flow-layout" data-shinyfunction="inputPanel"></div>';notes=["By default inputs will be aligned vertically, input panels enable the inputs to be aligned horizontally."];sortable_settings={group:{name:"shared",put:function(t,e,a){return a.classList.contains("form-group")||a.classList.contains("btn")}}};constructor(){super(),this.showRelevantOptions()}};var O=class extends i{name="Input";parameters=["type","id","label","width"];types=[{value:"text",label:"Text",r_func:"textInput"},{value:"textarea",label:"Text Area",r_func:"textAreaInput"},{value:"number",label:"Numeric",r_func:"numericInput"},{value:"password",label:"Password",r_func:"passwordInput"}];notes=["To position several inputs horizontally, they must be put within an input panel."];html=`
    ...
    `;constructor(){super(),this.showRelevantOptions(),this.updateTextInput("id",""),this.updateTextInput("label","Label"),this.updateTextInput("width","")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("input"):e;let a=this.validateCssUnit($("#sidebar-width").val()),n=a?`width: ${a};`:"",l=a?`, width = &quot;${a}&quot;`:"";return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,style_str:n,width_str:l})}updateComponent(t=!1){super.updateComponent(t),$(".component-container").find("select").selectize({labelField:"label",valueField:"value",searchField:["label"],placeholder:"select input"})}};var H=class extends i{name="Date";parameters=["id","label","range","width"];notes=["To position several inputs horizontally, they must be put within an input panel."];html=`
    ...
    `;constructor(){super(),this.showRelevantOptions(),this.updateTextInput("id",""),this.updateTextInput("label","Label"),this.updateTextInput("width","")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("input"):e;let a=this.validateCssUnit($("#sidebar-width").val()),n=a?`width: ${a};`:"",l=a?`, width = &quot;${a}&quot;`:"",r=document.getElementById("sidebar-range").checked,o=r?"dateRangeInput":"dateInput",d=r?"shiny-date-range-input":"shiny-date-input",h=r?this.date_range_input_html:this.date_input_html;return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,r_func:o,date_class:d,input_tag:h,style_str:n,width_str:l})}updateComponent(t=!1){super.updateComponent(t),$(".component-container").find("input").bsDatepicker()}};var R=class extends i{name="Checkbox";parameters=["id","label","width"];html=`
        <div class="designer-element form-group shiny-input-container" $style_str$
...
Choice 2`),this.updateTextInput("width","")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("checkbox"):e;var a=$("#sidebar-type").val();let n=this.types.find(v=>v.value===a);if(!n)return;let l=n.r_func,r=n.role,o=this.validateCssUnit($("#sidebar-width").val()),d=o?`width: ${o};`:"",h=o?`, width = &quot;${o}&quot;`:"";var u=document.getElementById("sidebar-inline").checked;let f=`shiny-input-${a}group${u?"-inline":""}`,g=$("#sidebar-choices").val(),m=`, choices = c(&quot;${g.replace(/\n/g,"&quot;, &quot;")}&quot;)`,w=g.split(`
`).map(v=>this.createCheckbox(v,e=e,a=a,u=u)).join("");return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,css_class:f,r_func:l,role:r,choices:w,choices_str:m,style_str:d,width_str:h})}createCheckbox(t,e="",a="checkbox",n=!1){var l=n?a+"-inline":a;return`<label class="${l}"><input type="${a}"><span>${t}</span></label>`}};var U=class extends i{name="Slider Input";parameters=["type","id","label","range","width"];types=[{value:"number",label:"Numeric"},{value:"date",label:"Date"},{value:"datetime",label:"Timestamp"}];notes=["To position several inputs horizontally, they must be put within an input panel."];html=`
        <div class="designer-element form-group shiny-input-container" $style_str$
    ...
    `;constructor(){super(),this.showRelevantOptions(),this.updateType(),this.updateTextInput("id",""),this.updateTextInput("label","Label"),this.updateTextInput("height","400px"),this.updateTextInput("width","100%"),this.updateLabel("id","Output ID")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("output"):e;let a=$("#sidebar-type").val(),n=this.types.find(m=>m.value===a);if(!n)return;let l=n.r_func,r=a==="verbatim"?"pre":"div",o=n.css_class,d="";if(["plot","image","table"].includes(a)){let m=this.createID("output");Shiny.setInputValue("sidebar-outputid",m),d=`id="sidebar-${m}"`}let u=document.getElementById("sidebar-inline").checked&&!["verbatim","table"].includes(a)?", inline = TRUE":"";u!==""&&(r="span");let b="",f="";if(["plot","image"].includes(a)){let m=this.validateCssUnit($("#sidebar-width").val(),"100%"),w=`width: ${m};`,v=m==="100%"?"":`, width = &quot;${m}&quot;`,j=this.validateCssUnit($("#sidebar-height").val(),"400px");w=w+` height: ${j};`,v=v+(j==="400px"?"":`, height = &quot;${j}&quot;`)}let g="";return n.placeholder&&(a==="html"?g=`<span>${n.placeholder}</span>`:g=`<span>${n.placeholder} ${$("#sidebar-textarea").val()}</span>`),this.replaceHTMLPlaceholders(this.html,{html_tag:r,id:e,label:t,id_str:d,r_func:l,css_class:o,style_str:f,dim_str:b,inline_str:u,output_tag:g})}updateComponent(t=!1){super.updateComponent(t),Shiny.bindAll()}};var A=class extends i{_item=1;name="Tab";constructor(){super(),$("#component_settings").css("display","none"),$("#tab_settings").css("display","unset")}updateComponent(){}getPageType(){return $("#settings-page_type input:radio:checked").val()}addPage(){let t=this.getPageType(),e=$("#sidebar-tab_name").val();if(this.checkDuplicateNames(e,t))return;let a=$("#sidebar-tab_value").val();a===""&&(a=this.createID("tab")),!this.checkDuplicateIDs(a,t)&&($("#sidebar-tab_alert div").alert("close"),t==="dashboardPage"?this.addMenuItem(e,a):this.addTab(e,a))}addTab(t,e){let a=$("ul.navbar-nav"),n=a.data("tabsetid"),l=$(".tab-content"),r=l.html()===""?"active":"";a.append(`
            <li class="${r}">
        ...
        `),this.enableSortablePage(`shiny-tab-${e}`)}enableSortablePage(t){Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(e,a,n){return!n.classList.contains("col-sm")}}})}checkDuplicateNames(t,e){return $(this.getNameIdentifier(t,e)).length>0?($("#sidebar-tab_alert").html(`
            ...
            `),!0):!1}getValueIdentifier(t,e){return e==="dashboardPage"?`ul.sidebar-menu a[data-value='${t}']`:`ul.navbar-nav a[data-value='${t}']`}deletePage(){let t=this.getPageType(),e=$("#sidebar-tab_name").val();if(!this.checkExistingNames(e,t))return!0;$("#sidebar-tab_alert div").alert("close"),t==="dashboardPage"?this.deleteMenuItem(e):this.deleteTab(e)}deleteTab(t){let e=$(`ul.nav a[data-name='${t}']`).data("value");$(`ul.nav a[data-name='${t}']`).parent().remove(),$(`.tab-content .tab-pane[data-value='${e}']`).remove()}deleteMenuItem(t){let e=$(`ul.nav a[data-name='${t}']`).data("value");$(`#tab-${e}`).parent().remove(),$(`#shiny-tab-${e}`).remove()}checkExistingNames(t,e){return $(this.getNameIdentifier(t,e)).length>0?!0:($("#sidebar-tab_alert").html(`
                <div class="alert alert-danger" role="alert">
            ...
            `),!1)}};var F=class extends i{name="Box";parameters=["label","colour","background","width_num"];notes=["If the width > 0, then the box is included in a column and can only be included in <b>rows</b>","Rows are split into 12 column units, if the sum of boxs' width exceeds 12, they get wrapped onto a new line"];html=`
    ...
    `;sortable_settings={group:{name:"shared",put:function(t,e,a){return!a.classList.contains("col-sm")}}};constructor(){super(),this.showRelevantOptions(),this.updateTextInput("value","-"),this.updateTextInput("label","Label"),this.updateTextInput("width_num",3)}createComponent(){let t=$("#sidebar-value").val(),e=$("#sidebar-label").val(),a=$("#sidebar-width_num").val(),n=a>0?`col-sm col-sm-${a}`:"",l=a>0?a:"NULL",r=$("#sidebar-background").val(),o=r==="white"?"":`bg-${r}`;return this.replaceHTMLPlaceholders(this.html,{value:t,label:e,width_class:n,width_r:l,colour:r,colour_class:o})}};function J(s){return s==="header"?new y:s==="row"?new P:s==="column"?new L:s==="text"?new D:s==="input_panel"?new S:s==="input"?new O:s==="dropdown"?new B:s==="file"?new M:s==="date"?new H:s==="checkbox"?new R:s==="radio"?new N:s==="slider"?new U:s==="button"?new E:s==="output"?new V:s==="tab_panel"?new A:s==="box"?new F:s==="value_box"?new z:new y}var c;function Z(){c=new J("header"),c.updateComponent(!0),$(".component-settings").on("change keyup",()=>c.updateComponent()),$(".component-comments").on("change blur",()=>c.updateComponent()),$(".component-container").on("mouseover",()=>{$(":focus").trigger("blur")}),$("#sidebar-tab_add").on("click",()=>c.addPage()),$("#sidebar-tab_delete").on("click",()=>c.deletePage()),$("#settings-component .dropdown-item").on("click",s=>{c=new J($(s.target).data("shinyelement")),c.updateComponent(!0),$("#settings-component .dropdown-item").removeClass("active"),$(s.target).addClass("active")})}function G(s,t=!1){var e=tt(s),a={tagName:s.tagName.toLowerCase(),r_function:s.dataset.shinyfunction,r_arguments:s.dataset.shinyattributes,r_comments:s.dataset.shinycomments,text:$(s).ignore().text().replace(/\s*\n\s*/g,""),htmlclass:s.className,children:e};return t?a:JSON.stringify(a)}$.fn.ignore=function(s){return this.clone().find(s||">*").remove().end()};function tt(s){for(var t=[],e=0;e<s.children.length;e++)if(s.children[e].dataset.shinyfunction)t.push(G(s.children[e],!0));else if(s.children[e].children.length){var a=tt(s.children[e]);a.length&&(t=t.concat(a))}return t}var Y=new Shiny.InputBinding;$.extend(Y,{find:function(s){return $(s).find(".page-canvas")},getValue:function(s){return G(document.getElementById("canvas-page"))},setValue:function(s,t){$(s).text(t)},subscribe:function(s,t){new MutationObserver(function(){t()}).observe(s,{subtree:!0,childList:!0,attributes:!0})},unsubscribe:function(s){$(s).off(".page-canvas")}});$(function(){Q(),Z(),X(),$(".help-icon").tooltip({boundary:"window",placement:"right"}),Sortable.create(document.getElementById("sidebar-bin"),{group:{name:"shared",pull:!1},handle:".designer-element",draggable:".designer-element",onAdd:function(s){this.el.removeChild(s.item)}})});Shiny.inputBindings.register(Y);
