var h=class{name;navbar_item_style="none";bs4_item_style="none";enable_on_load=!0;page_html;updateComponentDropdown(){$(".navbar-tab-item").css("display",this.navbar_item_style),$(".bs4-item").css("display",this.bs4_item_style);let t=this.navbar_item_style==="none"?"header":"tab";$(`#sidebar-${t}-body`).hasClass("show")||$(`#sidebar-${t}-header button`).trigger("click")}getPageHTML(t,e=""){return t.replaceAll("$page_id$",this.getTabID()).replaceAll("$title$",e)}updatePage(){let t=$("#canvas-title").html();$(".page-canvas").html(this.getPageHTML(this.page_html,t))}enableSortablePage(t,e="id"){e==="id"?Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(a,n,o){return!o.classList.contains("col-sm")}}}):document.getElementsByClassName(t).forEach(a=>{Sortable.create(a,{group:{name:"shared",put:function(n,o,l){return!l.classList.contains("col-sm")}}})})}getTabID(){return Math.round(Math.random()*8999+1e3)}};var q=class extends h{name="basicPage";enable_on_load=!1;page_html='<div id="canvas-page" class="container-fluid dimmed-canvas-page"></div>'};var P=class extends h{name="fillPage";page_html=`
    ...
    `};var k=class extends h{name="fixedPage";page_html=`
    ...
    `};var I=class extends h{name="fluidPage";page_html=`
        <div id="canvas-page" class="designer-page-template container-fluid" 
             ...
             data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
    `};var T=class extends h{name="bootstrapPage";page_html=`
    <div id="canvas-page" class="designer-page-template container-fluid" data-shinyfunction="bootstrapPage"
      data-shinyattributes="title = &quot;$title$&quot;, theme = bslib::bs_theme(4)"></div>
  `};var D=class extends h{name="navbarPage";navbar_item_style="";enable_on_load=!1;page_html=`
    ...
    `};var S=class extends h{name="dashboardPage";navbar_item_style="";bs4_item_style="";enable_on_load=!1;page_html=`
...
`).map(e=>'<li data-shinyfunction="tags$li">'+e+"</li>").join("")}};var B=class extends c{updatable=!1;html='<div class="designer-element shiny-input-panel shiny-flow-layout" data-shinyfunction="inputPanel"></div>';constructor(){super(),this.updateComponent(!0)}sortable_settings={group:{name:"shared",put:function(t,e,a){return a.classList.contains("form-group")||a.classList.contains("btn")}}}};var H=class extends c{constructor(t){super(),this.type=t,this.updateComponent(!0)}types=[{value:"text_input",label:"Text",r_func:"textInput"},{value:"textarea",label:"Textarea",r_func:"textAreaInput"},{value:"numeric",label:"Numeric",r_func:"numericInput"},{value:"password",label:"Password",r_func:"passwordInput"}];html=`
  ...
  `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-checkbox-label").val(),e=$("#sidebar-checkbox-id").val();e=e===""?this.createID("checkbox"):e;let a=this.validateCssUnit($("#sidebar-checkbox-width").val()),n=a?`style="width: ${a};"`:"",o=a?`, width = &quot;${a}&quot;`:"";return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,style_str:n,width_str:o})}};var R=class extends c{types=[{value:"radio",label:"Radio",r_func:"radioButtons",role:"radiogroup"},{value:"checkbox",label:"Checkbox",r_func:"checkboxGroupInput",role:"group"}];html=`
    ...
    `;constructor(){super(),this.updateComponent(!0)}createComponent(){let t=$("#sidebar-radio-label").val(),e=$("#sidebar-radio-id").val();e=e===""?this.createID("checkbox"):e;let a=$("#sidebar-radio-type").val(),n=this.types.find(x=>x.value===a);if(!n)return;let o=n.r_func,l=n.role,i=this.validateCssUnit($("#sidebar-radio-width").val()),r=i?`style="width: ${i};"`:"",d=i?`, width = &quot;${i}&quot;`:"",u=document.getElementById("sidebar-radio-inline").checked,p=u?"-inline":"",f=u?", inline = TRUE":"",v=`shiny-input-${a}group${p}`,b=$("#sidebar-radio-choices").val(),_=`, choices = c(&quot;${b.replace(/\n/g,"&quot;, &quot;")}&quot;)`,K=b.split(`
