var p=class{navbar_item_style="none";bs4_item_style="none";enable_on_load=!0;page_html;constructor(){}updateComponentDropdown(){$(".navbar-tab-item").css("display",this.navbar_item_style),$(".bs4-item").css("display",this.bs4_item_style),this.navbar_item_style==="none"?$("#settings-component a[name='header']").trigger("click"):$("#settings-component a[name='tab_panel']").trigger("click")}getPageHTML(t,e=""){return t.replaceAll("$page_id$",this.getTabID()).replaceAll("$title$",e)}updatePage(){let t=$("#canvas-title").html();$(".page-canvas").html(this.getPageHTML(this.page_html,t))}enableSortablePage(t){Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(e,a,n){return!n.classList.contains("col-sm")}}})}getTabID(){return Math.round(Math.random()*8999+1e3)}};var _=class extends p{page_html=`
    ...
    `;notes=["Columns can only be included in <b>rows</b>.","Rows are split into 12 column units, if the sum of columns' width exceeds 12, they get wrapped onto a new line."];sortable_settings={group:{name:"shared",put:function(t,e,a){return!a.classList.contains("col-sm")}}};constructor(){super(),this.showRelevantOptions(),$("#sidebar-width_num").attr("min",1)}createComponent(){let t=$("#sidebar-width_num").val(),e=$("#sidebar-offset").val(),a=e>0?` offset-md-${e}`:"",n=e>0?`, offset = ${e}`:"";return this.replaceHTMLPlaceholders(this.html,{width:t,offset_class:a,offset_r:n})}};var D=class extends i{name="Text";parameters=["tag","textarea"];tags=[{value:"p",label:"Paragraph <p>",text:"Paragraph <p>"},{value:"ol",label:"Ordered List <ol>",text:"Ordered List <ol>"},{value:"ul",label:"Unordered List <ul>",text:"Unordered List <ul>"}];html='<$tag$ class="designer-element" data-shinyfunction="tags$$tag$">$value$</$tag$>';constructor(){super(),this.showRelevantOptions(),this.updateTag(),this.updateTextInput("textarea","")}createComponent(){let t=$("#sidebar-tag").val(),e=$("#sidebar-textarea").val(),a=t==="p"?e.replace(/\n/g," "):this.createListItems(e);return this.replaceHTMLPlaceholders(this.html,{tag:t,value:a})}createListItems(t){return t.split(`
...
`).map(v=>this.createCheckbox(v,e=e,a=a,u=u)).join("");return this.replaceHTMLPlaceholders(this.html,{id:e,label:t,css_class:f,r_func:l,role:r,choices:w,choices_str:m,style_str:d,width_str:h})}createCheckbox(t,e="",a="checkbox",n=!1){var l=n?a+"-inline":a;return`<label class="${l}"><input type="${a}"><span>${t}</span></label>`}};var U=class extends i{name="Slider Input";parameters=["type","id","label","range","width"];types=[{value:"number",label:"Numeric"},{value:"date",label:"Date"},{value:"datetime",label:"Timestamp"}];notes=["To position several inputs horizontally, they must be put within an input panel."];html=`
    ...
    `;constructor(){super(),this.showRelevantOptions(),this.updateType(),this.updateTextInput("id",""),this.updateTextInput("label","Label"),this.updateTextInput("height","400px"),this.updateTextInput("width","100%"),this.updateLabel("id","Output ID")}createComponent(){let t=$("#sidebar-label").val(),e=$("#sidebar-id").val();e=e===""?this.createID("output"):e;let a=$("#sidebar-type").val(),n=this.types.find(m=>m.value===a);if(!n)return;let l=n.r_func,r=a==="verbatim"?"pre":"div",o=n.css_class,d="";if(["plot","image","table"].includes(a)){let m=this.createID("output");Shiny.setInputValue("sidebar-outputid",m),d=`id="sidebar-${m}"`}let u=document.getElementById("sidebar-inline").checked&&!["verbatim","table"].includes(a)?", inline = TRUE":"";u!==""&&(r="span");let b="",f="";if(["plot","image"].includes(a)){let m=this.validateCssUnit($("#sidebar-width").val(),"100%"),w=`width: ${m};`,v=m==="100%"?"":`, width = &quot;${m}&quot;`,j=this.validateCssUnit($("#sidebar-height").val(),"400px");w=w+` height: ${j};`,v=v+(j==="400px"?"":`, height = &quot;${j}&quot;`)}let g="";return n.placeholder&&(a==="html"?g=`<span>${n.placeholder}</span>`:g=`<span>${n.placeholder} ${$("#sidebar-textarea").val()}</span>`),this.replaceHTMLPlaceholders(this.html,{html_tag:r,id:e,label:t,id_str:d,r_func:l,css_class:o,style_str:f,dim_str:b,inline_str:u,output_tag:g})}updateComponent(t=!1){super.updateComponent(t),Shiny.bindAll()}};var A=class extends i{_item=1;name="Tab";constructor(){super(),$("#component_settings").css("display","none"),$("#tab_settings").css("display","unset")}updateComponent(){}getPageType(){return $("#settings-page_type input:radio:checked").val()}addPage(){let t=this.getPageType(),e=$("#sidebar-tab_name").val(),a=$("#sidebar-tab_value").val();if(a==="")a=this.createID("tab");else if(this.checkDuplicateIDs(a,t))return;$("#sidebar-tab_alert div").alert("close"),t==="dashboardPage"?this.addMenuItem(e,a):this.addTab(e,a)}addTab(t,e){let a=$("ul.navbar-nav"),n=a.data("tabsetid"),l=$(".tab-content"),r=l.html()===""?"active":"";a.append(`
        ...
        `),this.enableSortablePage(`shiny-tab-${e}`)}enableSortablePage(t){Sortable.create(document.getElementById(t),{group:{name:"shared",put:function(e,a,n){return!n.classList.contains("col-sm")}}})}checkDuplicateNames(t,e){return $(this.getNameIdentifier(t,e)).length>0?($("#sidebar-tab_alert").html(`
            ...
            `),!0)}};var F=class extends i{name="Box";parameters=["label","colour","background","width_num"];notes=["If the width > 0, then the box is included in a column and can only be included in <b>rows</b>","Rows are split into 12 column units, if the sum of boxs' width exceeds 12, they get wrapped onto a new line"];html=`
